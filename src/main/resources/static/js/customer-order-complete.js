...
//document.getElementById('message').innerHTML = orderIds.message;
function renderOrderIds(){
    ...
    orderIdHTML += `
        <div class="guide">주문번호를 기억해주세요.<br>옆에 종이가 구비되어있습니다.</div>
    `
...
completeBtn.addEventListener("click", () =>{
    ...
    window.location.href = "/customer/orderPage";
})
...
const countdownInterval = setInterval(() => {
    ...
    if (countdownTime > 0) {
        ...
        window.location.href = "/customer/orderPage";  // 주문 페이지로 이동
    }
